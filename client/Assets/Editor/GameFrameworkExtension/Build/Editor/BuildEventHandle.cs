    ...
    public class BuildEventHandle : IBuildEventHandler
    {
            ...
            int versionListHashCode, int versionListZipLength, int versionListZipHashCode)
        {
            ...
            VersionInfoEditorData versionInfoEditorData =
                AssetDatabase.LoadAssetAtPath<VersionInfoEditorData>("Assets/GameRes/Configs/VersionInfoEditorData.asset");
            if (versionInfoEditorData == null)
            {
                ...
                AssetDatabase.CreateAsset(versionInfoEditorData, "Assets/GameRes/Configs/VersionInfoEditorData.asset");
