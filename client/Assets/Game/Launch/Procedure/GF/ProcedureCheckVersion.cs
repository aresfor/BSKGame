...
namespace Game.Client
{
    public class ProcedureCheckVersion : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            // 向服务器请求版本信息
            var builtinDataComp =
                UnityGameFramework.Runtime.GameEntry.GetComponent<BuiltinDataComponent>();
            if (null == builtinDataComp)
            {
                Log.Error("builtinDataComponent is null");
                return;
            }
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            if (m_NeedUpdateVersion)
            {
                ...
                procedureOwner.SetData<VarInt32>("VersionListZipLength", m_VersionInfo.VersionListCompressedLength);
                procedureOwner.SetData<VarInt32>("VersionListZipHashCode", m_VersionInfo.VersionListCompressedHashCode);
