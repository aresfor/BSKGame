...
namespace Game.Client
{
    public class BaseMeshLoaderLogicSocket:EntityLogicSocketBase
    {
        ...
        [SerializeField]
        protected Transform m_DefaultMeshSocketTs;
        [SerializeField]
        protected string m_DefaultMeshPrefabName = "";
        ...
        {
            AvatarMeshLoader = new BaseMeshLoader( Entity, m_DefaultMeshPrefabName,m_DefaultMeshSocketTs,false);
