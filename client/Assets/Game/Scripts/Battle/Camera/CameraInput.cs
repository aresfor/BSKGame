...
using UnityEngine;
//@TEMP: 方便场景中直接调试
using InputUtils = UnityEngine.Input;
...
namespace Game.Client
{
    ...
    public class CameraInput : MonoBehaviour
    {
        ...
        protected void DoKeyboardPan()
        {
            ...
            // Left
            if (InputUtils.GetKey(KeyCode.LeftArrow) || InputUtils.GetKey(KeyCode.A))
            {
            ...
            // Right
            if (InputUtils.GetKey(KeyCode.RightArrow) || InputUtils.GetKey(KeyCode.D))
            {
            ...
            // Down
            if (InputUtils.GetKey(KeyCode.DownArrow) || InputUtils.GetKey(KeyCode.S))
            {
            ...
            // Up
            if (InputUtils.GetKey(KeyCode.UpArrow) || InputUtils.GetKey(KeyCode.W))
            {
        ...
        {
            Vector2 mousePos = InputUtils.mousePosition;
