...
namespace FlowCanvas
{
    ...
    abstract public partial class FlowNode : Node, ISerializationCallbackReceiver
    {
        ...
        protected Dictionary<string, object> _inputPortValues;

        [NonSerialized] //all input ports
        protected Dictionary<string, Port> inputPorts;
        [NonSerialized] //all output ports
        protected Dictionary<string, Port> outputPorts;
        ...
        protected void DeserializeInputPortValues() {
        ...
        [Conditional("UNITY_EDITOR")]
        protected void RefreshEditorPorts() {
#if UNITY_EDITOR && DO_EDITOR_BINDING
