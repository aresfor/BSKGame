...
namespace Game.Client
{
    ...
    {
        private static readonly string GlobalSettingsPath = $"GameFrameworkGlobalSettings";
        ...
        public static GameFrameworkSettings GlobalSettings
        {
            get
            {
                ...
                {
                    m_EngineGlobalSettings = //UnityGameFramework.Runtime.GameEntry.GetComponent<YooResourceComponent>().LoadAsset<GameFrameworkSettings>(GlobalSettingsPath);
                    GetSingletonAssetsByResources<GameFrameworkSettings>(GlobalSettingsPath);
                }
        ...
        {
            return Path.Combine(CompleteDownLoadPath, $"{ResourcesArea.ResAdminType}_{ResourcesArea.ResAdminCode}",
                GetPlatformName(), fileName).Replace("\\", "/");
        }
        ...
        public static string GetDictionaryAsset(string assetName, bool fromBytes)
        {
            ...
            //     GameSystem.GetComponent<LocalizationComponent>().Language.ToString(), assetName,
            //     fromBytes ? "bytes" : "xml");
        }
