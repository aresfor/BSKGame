...
namespace Game.UIFramework
{
    ...
    public class UISettings : ScriptableObject
    {
            ...
            if (instanceAndRegisterScreens) {
                foreach (var screen in screensToRegister) {
                    ...
                    if (screenController != null) {
                        newUI.RegisterScreen(screen.name, screenController);
                        newUI.ReparentScreen(screenController, screenInstance.transform);
        ...
        #if UNITY_EDITOR
        public void UpdateScreensToRegister(List<GameObject> allScreens)
        {
            screensToRegister.Clear();
            screensToRegister.AddRange(allScreens);
