...
public static class PhysicsUtils
{
    ...
    {
        return s_PhysicsUtility.SphereCheck(startTrace, endTrace, radius, traceFlag, ref hitPosition, ref hitNormal);
    }
    ...
    public static bool SingleLineCheck(float3 startTrace, float3 direction, float distance, int traceFlag,
        ...
        float duration = 5.0f)
    {
        return s_PhysicsUtility.SingleLineCheck(startTrace, direction, distance, traceFlag, ref impactInfo, bDrawLine,
            color, duration);
    }
