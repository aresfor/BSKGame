...
namespace Game.Gameplay
{
    ...
    public static class InputUtils
    {
        ...
        public static int MouseRayTraceLayer = PhysicsLayerDefine.GetFlag(PhysicTraceType.Graph) |
                                               PhysicsLayerDefine.GetFlag(PhysicTraceType.Pawn);

        public static readonly int DefaultRayTraceLayer = PhysicsLayerDefine.GetFlag(PhysicTraceType.Graph) |
                                                          PhysicsLayerDefine.GetFlag(PhysicTraceType.Pawn);
