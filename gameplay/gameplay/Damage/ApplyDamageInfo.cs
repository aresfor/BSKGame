...
public class ApplyPointDamageInfo : ApplyDamageInfo
{
    ...
    public static ApplyPointDamageInfo Create(int targetEntityId, int damageNum, EHitGroup hitGroup,float3 hitNormal, float3 hitPos, float3 hitDir , int casterEntityId = 0,
        int oweDamageEntityId = 0, bool bKillTarget = false)
    {
...
public class ApplyRadicalDamageInfo : ApplyDamageInfo
{
    ...
    public static ApplyRadicalDamageInfo Create(int targetEntityId, int damageNum, float3 radicalCenter, float3 hitPos, int casterEntityId = 0,
        int oweDamageEntityId = 0, bool bKillTarget = false)
    {
