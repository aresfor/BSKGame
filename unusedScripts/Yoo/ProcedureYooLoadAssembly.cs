...
namespace Game.Client
{
    ...
    /// 流程加载器 - 代码初始化
    /// </summary>
    public class ProcedureYooLoadAssembly : ProcedureBase
    {
        ...
        protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            if (!SettingsUtils.HybridCLRCustomGlobalSettings.Enable || GameEntry.YooResource.PlayMode == EPlayMode.EditorSimulateMode)
            {
            ...
            else
            {
                if (SettingsUtils.HybridCLRCustomGlobalSettings.Enable)
                {
                    foreach (string hotUpdateDllName in SettingsUtils.HybridCLRCustomGlobalSettings.HotUpdateAssemblies)
                    {
                        ...
                        m_LoadAssetCount++;
                        GameEntry.YooResource.LoadAsset<TextAsset>(assetLocation, LoadAssetSuccess);
                    }
        ...
        {
            ChangeState<ProcedureYooStartGame>(m_ProcedureOwner);
#if UNITY_EDITOR
            m_MainLogicAssembly = GetMainLogicAssembly();
#endif
        ...
        public void LoadMetadataForAOTAssembly()
        {
            ...
            foreach (string aotDllName in SettingsUtils.HybridCLRCustomGlobalSettings.AOTMetaAssemblies)
            {
                ...
                GameEntry.YooResource.LoadAsset<TextAsset>(assetLocation, LoadMetadataAssetSuccess);
            }
